...
if __name__ == '__main__':
    main()
'''
print("1 ",read_questions('/Users/k7677328/development/GCP/DataTeam/python-tutorial/python-exercises/example.txt'))
print("2 ", ask_questions(read_questions('/Users/k7677328/development/GCP/DataTeam/python-tutorial/python-exercises/example.txt')))
stats("3 ", stats(ask_questions(read_questions('/Users/k7677328/development/GCP/DataTeam/python-tutorial/python-exercises/example.txt'))))
'''